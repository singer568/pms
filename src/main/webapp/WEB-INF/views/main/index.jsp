...
#add_tab {
	cursor: pointer;
		...
		<script src='${ctx }/js/common/common.js' type="text/javascript">
</script>
	...
	<body>
		...
		<div id="centerPane"
			...
			<div id="tabs">
				<ul>
					<li>
						<a class="tabs-title" href="#tab-index">首页</a><span
							class='ui-icon ui-icon-close' title='关闭标签页'></span>
					</li>
				</ul>
				<div id="tab-index">
		...
		<div id="bottomPane"
			...
			<div class="footer ui-state-default">
				<span class="copyright">Copyright ©2013 杨红松</span>&nbsp;&nbsp;&nbsp;&nbsp;
