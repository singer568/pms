...
<html lang="en">
	...
	<body>
		...
		<div class="container showgrid">
			<form:form id="inputForm" action="${ctx}/spider/rule/${action}"
				...
				<fieldset>
					...
					<table border="1">
						<tr>
							...
							<td>
								<input type="text" id="code" name="code" value="${rule.code}" />
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type="text" id="name" name="name" value="${rule.name}" />
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td>
								<textarea id="description" name="description"
									class="input-large">${rule.description}</textarea>
							</td>
						</tr>
						<tr>
							<td>
