	...
	<body>
		...
		<table id="contentTable"
			...
			<tbody>
				...
				<c:forEach items="${levels.content}" var="level">
					<tr>
						<td>
							<a href="${ctx}/bd/level/update/${level.id}">${level.code}</a>
						</td>
						<td>
							${level.name}
						</td>
						...
						<td>
							<a href="${ctx}/bd/level/delete/${level.id}">删除</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
