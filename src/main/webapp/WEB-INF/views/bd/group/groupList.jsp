	...
	<body>
		...
		<table id="contentTable"
			...
			<tbody>
				...
				<c:forEach items="${groups.content}" var="group">
					<tr>
						<td>
							<a href="${ctx}/bd/group/update/${group.id}">${group.code}</a>
						</td>
						<td>
							${group.name}
						</td>
						...
						<td>
							<a href="${ctx}/bd/group/delete/${group.id}">删除</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
