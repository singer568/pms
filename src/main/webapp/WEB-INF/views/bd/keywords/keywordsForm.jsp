...
<html lang="en">
	...
	<body>
		...
		<div class="container showgrid">
			<form:form id="inputForm" action="${ctx}/bd/keywords/${action}"
				...
				<fieldset>
					...
					<table border="1">
						<tr>
							...
							<td>
								<input type="text" id="code" name="code" value="${keywords.code}" />
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type="text" id="name" name="name" value="${keywords.name}" />
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<textarea id="description" name="description"
									class="input-large">${keywords.description}</textarea>
							</td>
						</tr>
						<tr>
							<td>
