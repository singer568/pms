...
public class AttachedFileMail {
	...
	public static void main(String[] args) throws Exception {
		...
		String[] array = new String[] { "tomcat0506@163.com",
				"tomcat523@163.com" };
		// 设置收件人，寄件人
		messageHelper.setTo(array);
		messageHelper.setFrom("tomcat0506@163.com");
		...
		FileSystemResource file = new FileSystemResource(new File(
				"d:/项目估算表.xlsx"));
		// 这里的方法调用和插入图片是不同的。
		messageHelper.addAttachment("项目估算表.xlsx", file);

		senderImpl.setUsername("tomcat0506@163.com"); // 根据自己的情况,设置username
